...
insert into client
values (default, 'Коковихин', 'Даниил', 'Николаевич', '2003-12-31', 57, 1212121212, 'user1'),
       (default, 'Русаков', 'Егор', 'Алексеевич', '2004-09-18', 35, 5555566666, 'user2'),
       (default, 'Макаров', 'Алексей', 'Викторович', '1993-03-12', 23, 5838294932, 'user3'),
